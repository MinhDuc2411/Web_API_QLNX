...
namespace DuAnWeb_QLNX.Repository.LoginRepository
{
    public class ApiService: IApiService
    {
        ...
        public async Task<string> GetTokenAsync(string email, string password)
        {
            ...
            _logger.LogInformation("Gửi yêu cầu lấy token đến {url}", "https://localhost:7154/api/Account/Login");
            var response = await _httpClient.PostAsync("https://localhost:7154/api/Account/Login", content);
